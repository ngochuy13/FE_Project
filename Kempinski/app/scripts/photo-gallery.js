...
jQuery(function($){
    var photoGallery = (function() {
        ...
        var initPhotoSwipe = function() {
            ...
            zoomGallery = new PhotoSwipe( pswpElement, PhotoSwipeUI_Default, photoArray, options);
            zoomGallery.init();
        ...
        var photoGallery = {
            init: function(){
                ...
                view.each(function(){
                    ...
                    $(this).find(".photo-wrapper .item img").each(function(){
                        photoArray.push({
                ...
                view.find('.item').on('click', function(){
                    initPhotoSwipe();
                    var index = $.inArray(this, view.data('photoGallery').$items.filter('.visible'));
                    zoomGallery.goTo(index);
                });
                ...
                $(".photo-gallery-filter").filterSelect({
                    itemClickHandler: function(options, e){
                        ...
                        photoArray = [];
                        $(e.delegateTarget.getAttribute('data-target')).data('photoGallery').filter(type).each(function (i){
                            var item = this;
                            photoArray.push({
