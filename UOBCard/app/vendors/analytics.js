var pgDom = document.domain;
if (pgDom == "www.decision-science.com" || pgDom == "wip.projectuat.com" || "wcm.sg.uobnet.com" || pgDom == "pib.uob.com.sg" || pgDom == "www.uobgroup.com" || pgDom == "www.uob.com.sg" || pgDom == "www3.uobgroup.com" || pgDom == "www.uobgroup.com.sg" || pgDom == "uobgroup.com" || pgDom == "uob.com.sg" || pgDom == "uobgroup.com.sg" || pgDom == "uniservices1.uobgroup.com" || pgDom == "www.uobwealthbanking.com.sg" || pgDom == "www.uobwealthbanking.com" || pgDom == "uobwealthbanking.com.sg" || pgDom == "uobwealthbanking.com" || pgDom == "www.uobcashplus.com" || pgDom == "uobcashplus.com") { //pgDom validation start
...
http://www.omniture.com */
    ...
    s.linkInternalFilters = "javascript:,www.decision-science.com,,pib.uob.com.sg,www.uobgroup.com,www.uob.com.sg,www3.uobgroup.com,www.uobgroup.com.sg,uobgroup.com,uob.com.sg,uobgroup.com.sg,uniservices1.uobgroup.com,www.uobwealthbanking.com.sg,www.uobwealthbanking.com,uobwealthbanking.com.sg,uobwealthbanking.com"
    ...
    s.queryVarsList = "u_rfid,s_cid,s_pid,terms,AccountOfChoice,property,recommender,Category,SubCategory,location,preselect,searchType,searchBy,searchString,id,referer,referrer,subtopic" // query parameters to keep
    ...
    function s_pdfDownload(pdfName) {
        s.linkTrackVars = 'events,eVar2,eVar12';
        s.linkTrackEvents = 'event12';
        s.events = 'event12';
        s.eVar12 = pdfName;
        s.eVar2 = s.pageName;
        s.tl(this, 'o', 'pdf download');
    }

    function s_popup(formName) {
        s.linkTrackVars = 'events,eVar17';
        s.linkTrackEvents = 'event17';
        s.events = 'event17';
        s.eVar17 = formName;
        if (formName.indexOf("contact") > -1) {
            s.tl(this, 'o', 'contact us form');
        } else {
            s.tl(this, 'o', 'application form');
        }

    }

    function s_popupmenu(formName, nameConvention) {
    ...
    function s_utilities(formName) {
        s.linkTrackVars = 'events,eVar18';
        s.linkTrackEvents = 'event18';
        s.events = 'event18';
        s.eVar18 = formName;
        s.tl(this, 'o', 'utilities');
    }
    ...
    function s_doPlugins(s) {
        ...
        /*Gap Analysis */
        s.eVar6 = s.getQueryParam('s_pid');


        /* Site Specific Variables */
        s.prop1 = s.eVar1 = "sg:pweb";
        if (pgDom == "pib.uob.com.sg") s.prop1 = s.eVar1 = "sg:p2";

        /* Set Page Name*/
        if (!s.pageType && !s.pageName) {
            s.pageName = s.getPageName();
            s.pageName = "sg:pweb:en:" + s.pageName;
        }

        if (pgDom == "pib.uob.com.sg")
            s.pageName = s.pageName.replace(new RegExp(/:pweb:/g), ":p2:");

        s.pageName = s.pageName.toLowerCase();
        s.pageName = s.pageName.replace(new RegExp(/pages:/g), "");
        s.pageName = s.pageName.replace(new RegExp(/:en:zh:/g), ":zh:");
        s.pageName = s.pageName.replace(new RegExp(/:en:id:/g), ":id:");

        /* Set Channel and eVar2 - Site Section */
        if (!s.channel) {
            var valueArray = s.pageName.split(":");
            if (valueArray[3] != undefined) {
                s.channel = s.eVar2 = valueArray[0] + ':' + valueArray[1] + ':' + valueArray[2] + ':' + valueArray[3];
            }
        }

        /* Set prop2 and eVar3 - Sub Section */
        if (!s.prop2) {
            var valueArray = s.pageName.split(":");
            if (valueArray[4] != undefined) {
                s.prop2 = s.eVar3 = valueArray[0] + ':' + valueArray[1] + ':' + valueArray[2] + ':' + valueArray[3] + ':' + valueArray[4];
            }
        }
        /* Set prop3 and eVar4 - Sub Sub Section */
        if (!s.prop3) {
            var valueArray = s.pageName.split(":");
            if (valueArray[5] != undefined) {
                s.prop3 = s.eVar4 = valueArray[0] + ':' + valueArray[1] + ':' + valueArray[2] + ':' + valueArray[3] + ':' + valueArray[4] + ':' + valueArray[5];
            }
        }
        /* New and Repeat Visit */
        s.prop13 = s.getNewRepeat(30, 's_getNewRepeat');

        /* For Campaign pathing */
        if (s.campaign != '') {
            s.prop25 = s.getAndPersistValue(s.campaign, 's_getval', 30);
            s.prop26 = s.prop25 + '>' + s.pageName;
        }

        /* Cross Visit Campaign Stacking */
        s.eVar20 = s.crossVisitParticipation(s.campaign, 's_ev20', '30', '5', '>');
    }
...
the next lines. */
    ...
    s.server = "uob.com.sg"
    if (pgDom == "pib.uob.com.sg") s.server = "p2"
    ...
    s.state = ""
    s.zip = ""
    if (typeof eventsToOverride !== 'undefined') {
        s.events = eventsToOverride;
    } else
        s.events = "";
    s.products = ""
    s.purchaseID = ""
