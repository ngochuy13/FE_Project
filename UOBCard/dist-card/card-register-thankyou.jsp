...
<body class="one-card card-page card-thank-page">
    <input type="hidden" name="cardType" value="lady" />
    <div class="content-container">
        ...
        <div class="content">
            <div class="container">
                <form method="POST" id="card-document-form" class="card-document-form">
                    <div class="card-document-content">
                        <h3>You’re almost done. Please submit the following documents to <a href="mailto:uobcc.credit@uobgroup.com.">uobcc.credit@uobgroup.com</a>.</h3>
                        <div class="inner">
                            <ul>
                                <li>
                                    <img src="images/card-register/icfrontback.png" alt="">
                                    <span>NRIC (front and back)</span>
                                </li>
                                <li><em>AND</em></li>
                                <li>
                                    <img src="images/card-register/cpf.png" alt="">
                                    <span>Latest 12 months’ CPF Contribution History Statement via <a href="http://www.uob.com.sg/submitcpfstmt.html
" target="_blank">uobgroup.com.sg/submitcpfstmt.jsp</a> (Singpass required)</span>
                                </li>
                                <li><em>OR</em></li>
                                <li>
                                    <img src="images/card-register/payslip.png" alt="">
                                    <span>Latest Computerised Payslip (in Singapore Dollar currency)</span>
                                </li>
                                <li><em>OR</em></li>
                                <li>
                                    <img src="images/card-register/income.png" alt="">
                                    <span>Latest Income Tax Notice of Assessment with either <br> Latest 12 months’ CPF Contribution History Statement or <br> Latest Computerised Payslip (in Singapore Dollar currency) </span>
                                </li>
                            </ul>
                            <!-- <div class="drag-group">
                                <img src="images/card-register/clound.png" alt="">
                                <h4>DRAG & DROP</h4>
                                <p>your documents here or <a href="#">browse</a></p>
                                <input type="file" name="" value="" placeholder="">
                            </div> -->
                            <!-- <p>You may send the documents to <a href="mailto:uobcc.credit@uobgroup.com" title="">uobcc.credit@uobgroup.com</a><br/>or fax them at +65 66776677</p> -->
                        </div>
                    </div>
                    <!-- <div class="upload-group">
                        <div class="upload-item">
                            ...
                            <div class="upload-content">
                                <div class="upload-img nric-front">
                                    <img src="images/card-register/nric-front.png">
                                </div>
                        ...
                        <div class="upload-item">
                            <h4>NRIC (Back)</h4>
                            <div class="upload-content">
                                <div class="upload-img nric-back">
                                    <img src="images/card-register/nric-back.png">
                                </div>
                                <div class="upload-btn">
                                    <input type="file">    
                                </div>
                        ...
                        <div class="upload-item last-row">
                            <h4>CPF Contribution</h4>
                            <div class="upload-content">
                                <div class="upload-img cpf">
                                    <img src="images/card-register/cpf.png">
                                </div>
                                <div class="upload-btn">
                                    <input type="file">    
                                </div>
                        ...
                        <div class="upload-item">
                            <h4>Payslip</h4>
                            <div class="upload-content">
                                <div class="upload-img payslip">
                                    <img src="images/card-register/payslip.png">
                                </div>
                                <div class="upload-btn">
                                    <input type="file">    
                                </div>
                        ...
                        <div class="upload-item">
                            ...
                            <div class="upload-content">
                                <div class="upload-img income">
                                    <img src="images/card-register/income.png">
                                </div>
                                <div class="upload-btn">
                                    <input type="file">    
                                </div>
                    ...
                    <div class="form-group text-center">
                        <input type="submit" name="" value="Save a copy of your application" class="btn primary-btn btn-1">
                    </div>
                </form>
            </div>
            <div class="clearfix"></div>
