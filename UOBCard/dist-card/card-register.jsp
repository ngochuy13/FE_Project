                        ...
                        <div class="container">
                            ...
                            <div class="form-group-container form-group-fulldate-group">
                                <div class="form-group">
                                    ...
                                    <div class="fake-date-input date-inputs">
                                        <input type="text" name="dd_dob" value="<% if(jspVar_dd_dob != null) out.print(jspVar_dd_dob); %>"  placeholder="DD" class="form-control day-input ignore" maxlength="2" /><span>/</span>
                                        <input type="text" name="mm_dob" value="<% if(jspVar_mm_dob != null) out.print(jspVar_mm_dob); %>"  placeholder="MM" class="form-control month-input ignore" maxlength="2" /><span>/</span>
                                        <input type="text" name="yyyy_dob" value="<% if(jspVar_yyyy_dob != null) out.print(jspVar_yyyy_dob); %>"  placeholder="YYYY" class="form-control year-input ignore" maxlength="4" />
                                    </div>
                                </div>
                                <span class="separator"></span>
                            </div>
                            ...
                            <div class="hide" data-related-to="nationality" data-related-val="SG-Singapore|SG-Singapore-PR">
                                <div class="form-group-container">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="nric-1" name="nric1" value="<% if(nric1 != null) out.print(nric1); %>" />
                                        <input type="hidden" class="nric-2" name="nric2" value="<% if(nric2 != null) out.print(nric2); %>"/>
                                        <input type="hidden" class="nric-3" name="nric3" value="<% if(nric3 != null) out.print(nric3); %>"/>
                                    </div>
                                    <span class="separator"></span>
                                </div>
                            </div>
                            ...
                            <div class="hide" data-related-to="nationality" data-related-val="Others">
                                <div class="form-group-container form-group-fulldate-group">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control resembled-date" value="<% if(jspInt_ep_expiry_dd != null) out.print(jspInt_ep_expiry_dd); %>/<% if(jspInt_ep_expiry_mm != null) out.print(jspInt_ep_expiry_mm); %>/<% if(jspInt_ep_expiry_yyyy != null) out.print(jspInt_ep_expiry_yyyy); %>" name="dateOfEPassportExp" required data-rule-dateITA="true" tab="-1" />
                                        <div class="fake-date-input date-inputs">
                                            <input type="text" placeholder="DD" name="ep_expiry_dd" class="form-control day-input ignore" value="<% if(jspInt_ep_expiry_dd != null) out.print(jspInt_ep_expiry_dd); %>" maxlength="2" /><span>/</span>
                                            <input type="text" placeholder="MM" name="ep_expiry_mm" class="form-control month-input ignore" value="<% if(jspInt_ep_expiry_mm != null) out.print(jspInt_ep_expiry_mm); %>" maxlength="2" /><span>/</span>
                                            <input type="text" placeholder="YYYY" name="ep_expiry_yyyy" class="form-control year-input ignore" value="<% if(jspInt_ep_expiry_yyyy != null) out.print(jspInt_ep_expiry_yyyy); %>" maxlength="4" />
                                        </div>
                                    </div>
                                    <span class="separator"></span>
                                </div>
