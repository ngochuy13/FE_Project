...
module.exports = function(grunt) {
  ...
  var folders = {
    ...
    dist: 'dist',
    tmp: '.tmp',
    distServerSideImgCSS: '../public/',
    distServerSideScripts: '../public/scripts/'
  };
  ...
  grunt.initConfig({
    ...
    useminPrepare: {
      dist:{
        src: ['<%= folders.tmp %>/index.html', '<%= folders.tmp %>/game-play.html']
      },
      options: {
        dest: '<%= folders.dist %>'
      }
  ...
  grunt.registerTask('aa', function(target){
    concatCSS();
  });
