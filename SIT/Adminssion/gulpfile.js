...
var dependecyStyles = {
  'vendors.scss' : [
    'bower_components/font-awesome-sass/assets/stylesheets/font-awesome.scss',
    ...
    // 'bower_components/ttaccord/css/easy-responsive-tabs.css'
    // 'bower_components/webslidemenu/css/demo.scss',
    // 'bower_components/webslidemenu/css/color-theme.scss',
    // 'bower_components/webslidemenu/css/webslidemenu.scss',
    // 'bower_components/pushy/css/pushy.scss'
...
var folders = {
  ...
  dist: 'dist',
  tmp: '.tmp',
  serverJS: '../sites/default/themes/sit_theme/js',
  serverCSS: '../sites/default/themes/sit_theme/css'
};
var stylePth = ['app/styles/main.sass','app/styles/bootstrap.scss','app/styles/IE8.sass'];
// Style Related ============================================================
...
gulp.task('dist-asset-to-server', function() {
  gulp.src(folders.dist + "/styles/*.css").pipe(gulp.dest(folders.serverCSS));
  gulp.src(folders.dist + "/scripts/*.js").pipe(gulp.dest(folders.serverJS));
  return true;
});
